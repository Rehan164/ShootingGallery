...
namespace ShootingGallery
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (mState.LeftButton == ButtonState.Pressed && mReleased == true)
            {
                ...
                if (mouseTargetDist < targetRadius)
                {
                    ...
                    targetPosition.X = rand.Next(60,_graphics.PreferredBackBufferWidth-60);
                    targetPosition.Y = rand.Next(60,_graphics.PreferredBackBufferHeight-60);
                }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.DrawString(gameFont, "Your Score = " + score.ToString(), new Vector2(0, 0), Color.White);
